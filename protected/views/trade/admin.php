...
<div class="well">
    <span class="label label-info">上传数量:</span><span class="badge badge-warning"><?php echo $model->getUploadsCount(); ?></span>
    <span class="label label-success">上传收费:<?php echo $model->getUploadsCost(); ?></span>
    <span class="label label-info">交易数量:</span><span class="badge badge-warning"><?php echo $model->getStatisticsCount(); ?></span>
    <span class="label label-success">交易收费:<?php echo $model->getStatisticsCost(); ?></span>
</div>
